...
Released version is **0.1.12**, six platforms in one 474 MB drive, verlink
...
`bare test/index.js` is 43 tests / 603 asserts green. Seven of them are the P2P suite and pair two
