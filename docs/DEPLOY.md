...
| 2026-08-23 09:32 | **0.1.8** | _see run_ | all 6 | verified | — | bundles the graph viewer into the binary so `graph --html` works from an installed copy; also merges F PR #2 (real viewer) |
