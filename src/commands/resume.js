 ...
 * Carga una GraphSource (vault local) y formatea header, contratos, señales y tareas.
 */

const path = require('bare-path')
const os = require('bare-os')
const { loadVault } = require('../vault/index.js')
const { from, SEVERITY_RANK } = require('../core/graph.js')
...
/**
 * Carga la vault, arma el grafo y escribe el resumen.
 *
 * @param {{ vault?: string, cwd?: string, write?: Function, color?: boolean }} [opts]
 * @returns {Promise<{ graph: object, text: string }>}
 */
...
/**
 * Formato ANSI del resume (testeable, sin I/O).
...
module.exports = { runResume, formatResume, resolveStart }
